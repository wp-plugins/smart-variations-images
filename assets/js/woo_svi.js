if (!WOOSVI) {
    ...
    if (WOOSVI && typeof WOOSVI !== "object") {
        throw new Error("WEBDSJOGOSMAIN is not an Object type")
    }
}
...
WOOSVI.STARTS = function ($) {
    return{NAME: "Application initialize module", VERSION: 1.3, init: function () {
        ...
        //carrega as images e thumbnails consoante a cor seleccionada
        loadInits: function () {
        },
        //muda a imagem do produto directamente na página
            ...
            $select.click(function (e) {
                if (e.target.tagName === 'OPTION') {
                    ...
                    $('div.images div.thumbnails a').each(function (i, v) {
                        ...
                        var strColor = $(this).find('img').attr('alt').toLowerCase();
                        ...
                        if (strColor === $color) {
                            ...
                            if (count === 1) {
                                ...
                                var image_title = $(this).find('img').attr('alt').toLowerCase();
